...
const DATA = {
  ...
  about: "Frontend / React Developer with 4 years of experience building scalable fintech web applications and dashboards. Strong expertise in React.js, Next.js, TypeScript, Redux Toolkit, REST APIs, responsive UI design, and performance optimization. Experienced in component-driven architecture, state management, CI/CD pipelines, and modern frontend tooling.",
  stats: [
  ...
  projects: [
    { icon: "📱", num: "01", title: "UDS Partner Agent PWA", desc: "Mobile-first Progressive Web App for Easebuzz field agents to streamline merchant onboarding with KYC workflows and real-time dashboards.", color: "#6366F1", colorRgb: "99,102,241", tech: ["React 18", "TypeScript", "Vite", "Ant Design", "PWA"], highlights: ["KYC workflows & document upload", "Role-based auth & authorization", "Real-time dashboards & analytics", "Offline-ready PWA architecture"] },
    { icon: "🤖", num: "02", title: "GenAI – Easebuzz ERA", desc: "AI-powered dynamic form generation integrated with Easebuzz Rapid Assist, enabling prompt-driven workflows for custom forms.", color: "#F59E0B", colorRgb: "245,158,11", tech: ["React.js", "Redux Toolkit", "GenAI", "JSON Schema"], highlights: ["Prompt-driven AI form generation", "AI JSON schema → React forms", "Real-time form rendering", "70% less manual form creation time"] },
    { icon: "🏦", num: "03", title: "Bandhan Bank Integration", desc: "Customer-facing frontend of Bandhan Bank's payment integration with seamless Java backend service connectivity.", color: "#10B981", colorRgb: "16,185,129", tech: ["React.js", "Redux Toolkit", "REST APIs", "Java Backend"], highlights: ["Customer-facing banking UI", "Seamless Java backend integration", "Optimized API interactions"] },
    { icon: "🎓", num: "04", title: "Edu-revamp Project", desc: "Migration of a fee collection system from Angular to React with performance optimization and a custom drag-and-drop form builder.", color: "#EC4899", colorRgb: "236,72,153", tech: ["React.js", "Angular Migration", "Lazy Loading", "REST APIs"], highlights: ["Angular → React migration (+25%)", "Lazy loading (−15% load time)", "Drag-and-drop form builder"] },
  ],
  certifications: [
...
function Navbar() {
  ...
  return (
    <>
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: scrolled ? "0.8rem 2rem" : "1.25rem 2rem", background: scrolled ? "rgba(8,11,20,.9)" : "transparent", backdropFilter: scrolled ? "blur(20px)" : "none", borderBottom: scrolled ? "1px solid rgba(255,255,255,.07)" : "none", transition: "all .3s" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <ul style={{ display: "flex", alignItems: "center", gap: "1.75rem", listStyle: "none" }} className="nav-desktop">
            ...
            <li>
              <a href="https://linkedin.com/in/nileshshete" target="_blank" rel="noreferrer" style={{ padding: "8px 18px", background: "#38BDF8", color: "#050810", borderRadius: 8, fontSize: 13, fontWeight: 700, textDecoration: "none" }}>Hire Me</a>
            </li>
          </ul>
          <button onClick={() => setOpen(!open)} style={{ display: "none", flexDirection: "column", gap: 5, background: "none", border: "none", cursor: "pointer", padding: 4 }} className="burger-btn" aria-label="menu">
            {[0,1,2].map(i => <span key={i} style={{ display: "block", width: 24, height: 2, background: "#F0F4FF", borderRadius: 2, transition: "all .3s", transform: open && i===0 ? "rotate(45deg) translate(5px,5px)" : open && i===2 ? "rotate(-45deg) translate(5px,-5px)" : "none", opacity: open && i===1 ? 0 : 1 }} />)}
          </button>
        </div>
      </nav>
      {open && (
        <div style={{ position: "fixed", top: 0, right: 0, height: "100vh", width: 280, background: "rgba(13,18,32,.98)", backdropFilter: "blur(30px)", zIndex: 99, display: "flex", flexDirection: "column", justifyContent: "center", gap: "2rem", padding: "2rem", borderLeft: "1px solid rgba(255,255,255,.07)" }}>
          ...
          <a href="https://linkedin.com/in/nileshshete" target="_blank" rel="noreferrer" style={{ padding: "10px 20px", background: "#38BDF8", color: "#050810", borderRadius: 9, fontSize: 14, fontWeight: 700, textDecoration: "none", textAlign: "center" }}>Hire Me</a>
        </div>
      )}
      <style>{`
    ...
    <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", paddingTop: 100, paddingBottom: 60, position: "relative", zIndex: 1 }} className="section">
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem", width: "100%" }} className="hero-content">
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: "3rem", alignItems: "center", marginBottom: 64 }} className="hero-grid">
          <div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(52,211,153,.09)", border: "1px solid rgba(52,211,153,.25)", borderRadius: 999, padding: "6px 16px", fontSize: 13, color: "#34D399", fontWeight: 500, marginBottom: "1.5rem", animation: "fadeUp .6s .1s both" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 7, marginBottom: "2rem", animation: "fadeUp .6s .4s both" }}>
              {["React.js","Next.js","TypeScript","Redux","TailwindCSS"].map(t => (
                <span key={t} style={{ padding: "5px 12px", background: "rgba(129,140,248,.09)", border: "1px solid rgba(129,140,248,.22)", borderRadius: 6, fontSize: 12, color: "#818CF8", fontWeight: 500 }}>{t}</span>
              ))}
            </div>
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "1.75rem", animation: "fadeUp .6s .45s both" }} className="hero-buttons">
              <a href="#projects" style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "13px 26px", background: "#38BDF8", color: "#050810", fontSize: 14.5, fontWeight: 700, borderRadius: 10, textDecoration: "none" }}>
                View My Work <span>→</span>
              </a>
              <a href="https://linkedin.com/in/nileshshete" target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "12px 25px", background: "transparent", color: "#F0F4FF", fontSize: 14.5, border: "1px solid rgba(255,255,255,.1)", borderRadius: 10, textDecoration: "none" }}>
                LinkedIn ↗
              </a>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "1.5rem", padding: "2rem", background: "#0D1220", border: "1px solid rgba(255,255,255,.07)", borderRadius: 16, animation: "fadeUp .6s .65s both" }} className="stat-grid">
          {DATA.stats.map(s => (
...
function SocialIcon({ href, children }) {
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer" onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{ width: 40, height: 40, display: "flex", alignItems: "center", justifyContent: "center", border: `1px solid ${hov ? "#38BDF8" : "rgba(255,255,255,.1)"}`, borderRadius: 10, color: hov ? "#38BDF8" : "#8892AA", textDecoration: "none", transition: "all .2s" }}>
      {children}
    </a>
  );
}
...
function AvatarOrb() {
  return (
    <div style={{ position: "relative", width: 240, height: 240, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }} className="avatar-orb">
      ...
      <div style={{ width: 140, height: 140, background: "rgba(56,189,248,.09)", border: "2px solid rgba(56,189,248,.3)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Syne',sans-serif", fontSize: "2.4rem", fontWeight: 800, color: "#38BDF8", position: "relative", zIndex: 2 }}>NS</div>
      {[
        ...
        <div key={i} style={{ position: "absolute", background: "#0D1220", border: "1px solid rgba(255,255,255,.09)", borderRadius: 9, padding: "6px 12px", fontSize: 11, fontWeight: 500, whiteSpace: "nowrap", zIndex: 3, animation: `flt 4s ease-in-out ${b.delay}s infinite`, top: b.top, right: b.right, bottom: b.bottom, left: b.left }}>
          {b.text}
        </div>
      ))}
    </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem" }}>
        <FadeUp>
            ...
            <div>
              ...
              <p style={{ color: "#8892AA", fontSize: 15.5, lineHeight: 1.8 }}>I thrive at the intersection of design and engineering — turning complex business requirements into clean, intuitive, and performant interfaces. My work spans fintech dashboards, PWAs, GenAI integrations, and banking portals.</p>
              <div style={{ marginTop: "2rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
                {[
                  ...
                  <div key={item.label} style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                    <div style={{ width: 36, height: 36, background: "rgba(56,189,248,.08)", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem", flexShrink: 0 }}>{item.icon}</div>
                    <div>
              ...
              <div style={{ display: "flex", gap: "1rem", marginTop: "2rem", flexWrap: "wrap" }}>
                {/* <a href={`mailto:${DATA.email}`} style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "12px 24px", background: "#38BDF8", color: "#050810", fontSize: 14, fontWeight: 700, borderRadius: 10, textDecoration: "none" }}>Get In Touch</a> */}
                <a href={DATA.linkedin} target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 7, padding: "11px 23px", background: "transparent", color: "#F0F4FF", fontSize: 14, border: "1px solid rgba(255,255,255,.1)", borderRadius: 10, textDecoration: "none" }}>View LinkedIn</a>
              </div>
            </div>
    ...
    <section id="projects" style={{ padding: "100px 0", position: "relative", zIndex: 1 }} className="section">
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem" }}>
        <FadeUp>
          ...
          <p style={{ color: "#8892AA", maxWidth: 580, marginBottom: "3rem", fontSize: 15.5 }}>A curated selection of projects from my 4 years at Easebuzz — fintech dashboards, PWAs, GenAI integrations, and banking portals.</p>
...
function ProjectCard({ project: p }) {
  ...
  return (
    <div
      ...
      onMouseLeave={() => setHov(false)}
      style={{ position: "relative", overflow: "hidden", background: hov ? "#131929" : "#0D1220", border: `1px solid ${hov ? p.color + "55" : "rgba(255,255,255,.07)"}`, borderRadius: 16, padding: "2rem", display: "flex", flexDirection: "column", gap: "1rem", transition: "all .3s", transform: hov ? "translateY(-3px)" : "none" }}
    >
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: "auto" }}>
        {p.tech.map(t => (
          <span key={t} style={{ padding: "4px 11px", background: `rgba(${p.colorRgb},.08)`, border: `1px solid rgba(${p.colorRgb},.28)`, borderRadius: 999, fontSize: 12, color: p.color, fontWeight: 500 }}>{t}</span>
        ))}
      </div>
    </div>
  );
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem" }}>
        <FadeUp>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1.25rem" }} className="skills-grid">
            {DATA.skills.map(cat => (
              <Card key={cat.name} style={{ padding: "1.5rem", gridColumn: cat.span2 ? "span 2" : "span 1" }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {cat.items.map(item => (
                    <span key={item} style={{ padding: "5px 11px", background: `${cat.color}0D`, border: `1px solid ${cat.color}28`, borderRadius: 6, fontSize: 12.5, fontWeight: 500, color: "#F0F4FF" }}>{item}</span>
                  ))}
                </div>
              </Card>
            ))}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "1.5rem", marginTop: "3rem" }} className="edu-grid">
            {DATA.education.map((edu, i) => (
              <Card key={i} style={{ position: "relative", padding: "2rem" }}>
                <div style={{ fontFamily: "'Syne',sans-serif", fontSize: "3rem", fontWeight: 800, color: "#F0F4FF", opacity: 0.07, position: "absolute", top: "1.5rem", right: "1.5rem", lineHeight: 1 }}>{edu.year}</div>
                ...
                {edu.latest && <div style={{ display: "inline-block", marginTop: "1rem", padding: "4px 12px", background: "rgba(56,189,248,.08)", border: "1px solid rgba(56,189,248,.22)", borderRadius: 999, fontSize: 11, color: "#38BDF8", fontWeight: 600, letterSpacing: "0.05em" }}>Latest Degree</div>}
              </Card>
            ))}
          </div>
        </FadeUp>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem" }}>
        <FadeUp>
            ...
            <div>
              ...
              <p style={{ color: "#8892AA", fontSize: 15.5, lineHeight: 1.8, marginBottom: "2.5rem" }}>I'm currently open to new opportunities. Whether you have a project in mind, want to discuss a role, or just want to connect — my inbox is always open.</p>
            ...
            <Card style={{ padding: "2.5rem", background: "linear-gradient(135deg,rgba(56,189,248,.05),rgba(129,140,248,.05))", borderColor: "rgba(56,189,248,.15)" }} hover={false}>
              ...
              <p style={{ color: "#8892AA", fontSize: 14.5, lineHeight: 1.75, marginBottom: "2rem" }}>I'm available for full-time roles, freelance projects, and consulting. Let's discuss how I can contribute to your team.</p>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
                <a href={`mailto:${DATA.email}`} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "13px 0", background: "#38BDF8", color: "#050810", fontSize: 14.5, fontWeight: 700, borderRadius: 10, textDecoration: "none" }}>Send me an Email →</a>
                <a href={DATA.linkedin} target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 0", background: "transparent", color: "#F0F4FF", fontSize: 14.5, border: "1px solid rgba(255,255,255,.1)", borderRadius: 10, textDecoration: "none" }}>Connect on LinkedIn</a>
              </div>
            </Card>
          </div>
        </FadeUp>
...
function ContactLink({ href, label, value, icon }) {
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer"
      ...
      style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "1rem 1.25rem", background: "#0D1220", border: `1px solid ${hov ? "#38BDF8" : "rgba(255,255,255,.07)"}`, borderRadius: 12, textDecoration: "none", transition: "all .2s", transform: hov ? "translateX(4px)" : "none" }}>
      <div style={{ width: 44, height: 44, background: "rgba(56,189,248,.08)", border: "1px solid rgba(56,189,248,.15)", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", color: "#38BDF8", flexShrink: 0 }}>{icon}</div>
      <div>
  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0 }}>
        ...
        <div style={{ position: "absolute", width: 600, height: 600, background: "#818CF8", borderRadius: "50%", filter: "blur(120px)", bottom: 100, left: -200, opacity: 0.07, animation: "blobf 12s ease-in-out infinite reverse" }} />
      </div>
      <Navbar />
      <main>
        <Hero />
